...
export default function UserInvestment() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setInvestments([
        ...
        { id: 2, userId: 1, amount: 2000, type: 'referral', date: '2024-02-20', txHash: '0x456...def', status: 'confirmed' },
        { id: 3, userId: 1, amount: 2000, type: 'new', date: '2024-03-10', txHash: '0x789...ghi', status: 'confirmed' },
      ]);
      setLoading(false);
    }, 500);
  }, [router]);
  ...
  return (
    <div className={styles.pageContainer}>
      <div className="mb-4">
        <h1 className="h3 fw-bold mb-2">User Investments</h1>
        <p className="text-muted">View and manage user investment records</p>
      </div>
